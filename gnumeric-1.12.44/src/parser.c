...
{
       0,   612,   612,   618,   626,   632,   635,   636,   637,   641,
     642,   643,   644,   645,   646,   647,   648,   649,   650,   651,
     652,   653,   654,   655,   656,   657,   662,   666,   670,   671,
     673,   691,   698,   699,   710,   731,   748,   749,   752,   753,
     756,   757,   785,   807,   816,   828,   829,   833,   837,   841,
     847,   852,   863,   873,   876,   877,   882,   887,   891,   892,
     897,   905,   910
};
#endif
...
#line 699 "parser.y" /* yacc.c:1646  */
    {
		...
		GnmExpr const *ename = parser_simple_name (name, (yyvsp[-1].sheet));

		if (ename) {
			unregister_allocation ((yyvsp[0].expr)); gnm_expr_free ((yyvsp[0].expr));
			(yyval.expr) = register_expr_allocation (ename);
		} else {
			YYERROR;
		}
	}
